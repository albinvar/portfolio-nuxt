<template>
  <div class="bg-gray-900 relative inset-x-0 bottom-0">
    <div
      class="px-4 mx-auto max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8"
    >
      <div
      ...
      >
        ...
        >
          <a
            ...
            target="_blank"
            class="text-gray-500 transition-colors duration-300 hover:text-gray-400"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <a
            ...
            target="_blank"
            class="text-gray-500 transition-colors duration-300 hover:text-gray-400-accent-400"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
