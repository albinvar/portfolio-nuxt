  ...
  <div>
    <section class="bg-white py-3 lg:py-20">
      <div @click="animate" class="flex items-end justify-center my-6">
        <img :class="{'animate__jackInTheBox': animated}"  @animationend="animated = false" class="h-56 w-56 rounded-full shadow-lg animate__animated" oncontextmenu="return false" src="~/assets/images/me.webp" />
      </div>
